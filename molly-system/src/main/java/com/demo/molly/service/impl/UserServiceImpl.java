...
import com.demo.molly.projection.UserWithRoles;
...
public class UserServiceImpl implements UserService {
    ...
    @Autowired
    public UserServiceImpl(UserMapper userMapper, PasswordEncoder passwordEncoder, TokenCacheService tokenCacheService) {
    ...
    public PageResult<UserVO> list(KeywordStatusQuery query) {
        PageInfo<UserWithRoles> pageInfo = PageHelper.startPage(query.getPageNum(), query.getPageSize())
        ...
        for (UserWithRoles user : pageInfo.getList()) {
            list.add(toVO(user));
        }
    ...
    public UserVO detail(Long id) {
        UserWithRoles user = userMapper.findById(id);
        if (user == null) {
    ...
    private UserVO toVO(UserWithRoles user) {
